...
export const config = {
  ...
  business: {
    ...
    pointsPerPurchase: getNumericEnvVar('POINTS_PER_PURCHASE', 10),
    minimumPurchaseForPoints: getNumericEnvVar('MINIMUM_PURCHASE_FOR_POINTS', 10000),
    pointsToRupiah: getNumericEnvVar('POINTS_TO_RUPIAH', 100),
    minimumRedeemPoints: getNumericEnvVar('MINIMUM_REDEEM_POINTS', 500)
  },
...
// Export individual configuration sections for easier access
export const databaseConfig = config.database;
export const authConfig = config.auth;
export const apiConfig = config.api;
export const businessSettings = config.business;
export const emailConfig = config.email;
export const socialConfig = config.social;
export const mapsConfig = config.maps;
export const xenditConfig = config.xendit;
export const rajaongkirConfig = config.rajaongkir;
